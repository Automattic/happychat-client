...
import { isExternal, addSchemeIfMissing, setUrlScheme } from 'src/lib/url';

const debug = require( 'debug' )( 'happychat-embedded:ui:timeline' );
...
const renderGroupedMessages = ( { item, isCurrentUser }, index ) => {
	...
	return (
		<div
			className={ classnames( 'happychat__timeline-message', { 'is-user-message': isCurrentUser } ) }
			key={ event.id || index }
		>
