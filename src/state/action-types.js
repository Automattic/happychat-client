...
export const HAPPYCHAT_FALLBACK_TICKET_OPTIONS = 'HAPPYCHAT_FALLBACK_TICKET_OPTIONS';
...
export const HAPPYCHAT_IO_RECEIVE_TYPING = 'HAPPYCHAT_IO_RECEIVE_TYPING';
...
export const HAPPYCHAT_IO_SET_CHAT_FIELDS = 'HAPPYCHAT_IO_SET_CHAT_FIELDS';

export const HAPPYCHAT_MINIMIZING = 'HAPPYCHAT_MINIMIZING';
export const HAPPYCHAT_OPEN = 'HAPPYCHAT_OPEN';
export const HAPPYCHAT_RESET_FORM = 'HAPPYCHAT_RESET_FORM';
export const HAPPYCHAT_SET_CURRENT_MESSAGE = 'HAPPYCHAT_SET_CURRENT_MESSAGE';
export const HAPPYCHAT_SET_HAS_UNREAD_MESSAGES = 'HAPPYCHAT_SET_HAS_UNREAD_MESSAGES';
export const HAPPYCHAT_SET_IS_DISPLAYING_NEW_MESSAGES = 'HAPPYCHAT_SET_IS_DISPLAYING_NEW_MESSAGES';
export const HAPPYCHAT_SET_OPERATOR_IS_TYPING = 'HAPPYCHAT_SET_OPERATOR_IS_TYPING';
export const HAPPYCHAT_USER_CURRENT_SET = 'HAPPYCHAT_USER_CURRENT_SET';
export const HAPPYCHAT_USER_ELIGIBILITY_SET = 'HAPPYCHAT_USER_ELIGIBILITY_SET';
...
export const HAPPYCHAT_FORM_DEFAULT_VALUES = 'HAPPYCHAT_FORM_DEFAULT_VALUES';